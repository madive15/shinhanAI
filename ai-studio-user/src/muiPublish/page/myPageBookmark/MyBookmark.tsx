...
import MyBookmarkTable from "~/muiPublish/page/myPageBookmark/MyBookmarkTable";
 ...
 * @author shinhanAI
 * @description
 * user-front: MyBookmark
 * MyBookmark page
 */
const MyBookmark: React.FC<IPageProps> = (props) => {
    // loading
