...
const ModelAddPopup: React.FC<IPageProps> = (props) => {
    ...
    return (
        <>
            <Dialog className="layer-box large" open={props.popupStauts} onClose={popupClose}>
                ...
                <DialogContent>
                    ...
                    <TableContainer className="table-content" sx={{ maxHeight: 410, scrollbarWidth: "thin" }}>
                        <Table stickyHeader className="table-defult-style" aria-label="모델추가 리스트">
                            <TableHead>
                                <TableRow>
