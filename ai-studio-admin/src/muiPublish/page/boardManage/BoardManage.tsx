...
import BoardManageTable from "~/muiPublish/page/boardManage/BoardManageTable";
 ...
 * @author shinhanAI
 * @description
 * admin-front: BoardManage
 */
const BoardManage: React.FC<IPageProps> = (props) => {
    // loading
                ...
                <div className="tabs-scroll-area">
                    <div className="table-title" ref={subTitleLeft}>
                        ...
                        <div className="table-title-right">
                            ...
                            <Button variant="primary">게시글 등록</Button>
                        </div>
                    </div>
                    <BoardManageTable
