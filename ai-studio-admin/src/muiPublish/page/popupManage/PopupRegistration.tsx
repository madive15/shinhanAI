...
import PopupRegiTable from "~/muiPublish/page/popupManage/PopupRegiTable";
 ...
 * @author shinhanAI
 * @description
 * admin-front: PopupRegistration
 */
const PopupRegistration: React.FC<IPageProps> = (props) => {
    // loading
        ...
        <>
            ...
            >
                ...
                <div className="tabs-scroll-area">
                    ...
                    <PopupRegiTable pageName={props.pageName} />
                    <div
                        className="btn-root-wrap end"
                        aria-label="Basic button group"
                    >
                        <Button variant="sub1">등록 취소</Button>
                        <Button variant="sub2">미리 보기</Button>
