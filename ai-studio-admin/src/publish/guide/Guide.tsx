        ...
        <>
            <div className="guide-wrap">
                ...
                <div className="guide-tab-content">
                    {/* color */}
                    {activeTab === "tab1" && (
                        <div className="guide-color" style={{ backgroundColor: "#fff", padding: "20px" }}>
                    ...
                    {activeTab === "tab3" && (
                        <div className="guide-checkbox">
                            ...
                            <Checkbox label="체크박스" id="chk1-1" checked={isChecked} onChange={setIsChecked} />
                            <Checkbox label="체크박스" id="chk1-2" checked={isChecked2} onChange={setIsChecked2} />
                            <Checkbox
                                label="체크박스"
                                id="chk1-3"
                                checked={isChecked3}
                            ...
                            <Checkbox id="chk2-3" checked={isChecked6} onChange={setIsChecked6} disabled={true} />

                            <strong>체크박스 그룹</strong>
                            <CheckboxGroup>
                                <Checkbox id="chk3-1" label="체크박스2" checked={isChecked7} onChange={setIsChecked7} />
                                <Checkbox id="chk3-2" label="체크박스3" checked={isChecked8} onChange={setIsChecked8} />
                                <Checkbox
                                    id="chk3-3"
                                    label="체크박스4"
                                    checked={isChecked9}
                    ...
                    {activeTab === "tab5" && (
                        <div className="guide-input">
                            ...
                            <InputText
                                ...
                                maxLength={30}
                            />
                            <InputText id="inputText2" value={text2} onChange={setText2} placeholder="플레이스홀더" />
                            <InputText
                                id="inputText3"
                                value={text3}
                                onChange={setText3}
                    ...
                    {activeTab == "tab6" && (
                        <div className="guide-button">
                            ...
                            <ButtonWrap viewType="center">
                                ...
                                <Button value="버튼 텍스트" viewType="primary" disabled={true} />
                            </ButtonWrap>
                            ...
                            <div className="switch">
                                <Button viewType={`switch ${toggleswitch ? "on" : ""}`} onClick={btnSwitch} />
                            </div>
                        </div>
                    )}
                    {/* admintab */}
                    ...
                    {activeTab == "tab9" && (
                        <div className="guide-modal">
                            ...
                            <ButtonWrap viewType="start">
                                <Button value="alert" viewType="primary" onClick={() => openModal("modal1")} />
                                <Button value="confirm" viewType="primary" onClick={() => openModal("modal2")} />
                            </ButtonWrap>
                            <Modal
                                type="alert"
                                content={
                    ...
                    {activeTab == "tab10" && (
                        <div className="guide-textarea">
                            ...
                            />
                            <Textarea value={textarea2} onChange={setTextarea2} placeholder="텍스트 에어리어2" />
                            <Textarea
                                value={textarea3}
                    ...
                    {activeTab == "tab12" && (
                        <div className="guide-select">
                            ...
                            <Select options={options} placeholder="비활성화된 Select" disabled={true} />
                            <Select options={options} placeholder="Select" tag={true} />
                            <Select options={options} placeholder="Select" disabled={true} tag={true} />
                        </div>
                    )}
                    {/* hash */}
                    {activeTab == "tab13" && (
                    ...
                    {activeTab == "tab15" && (
                        <div className="guide-hash">
                            ...
                            <ButtonWrap viewType="start">
                                ...
                                />
                                <Button value="레이어팝업" viewType="primary" onClick={() => openPopup("popup3")} />
                            </ButtonWrap>
                            <LayerPopup
                                title="타이틀1"
                            ...
                            <LayerPopup isOpen={popups.popup2} size="small" onClose={() => closePopup("popup2")}>
                                <p>팝업2</p>
                            </LayerPopup>

                            <LayerPopup title="타이틀3" isOpen={popups.popup3} onClose={() => closePopup("popup3")}>
                                <p>팝업3</p>
                            </LayerPopup>
                        </div>
                    )}
